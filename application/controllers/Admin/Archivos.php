...
class Archivos extends MY_Controller {
		...
		public function index($dir = 'root')
		{
				...
				$data['head_includes'] = array('file-input' => link_tag('js/fileinput-master/css/fileinput.min.css'), 'lightbox' => link_tag('js/lightbox2-master/dist/css/lightbox.min.css'));
