...
<div class="multiple-options">
	...
	<a class="opt-delete tooltipped btn-delete-multiple modal-trigger" data-position="left" data-delay="50" data-tooltip="Borrar" href="#<?php echo $modalid; ?>" data-action-param='{"table":"album"}' data-url="admin/galeria/fn_ajax_delete_data" data-ajax-action="inactive" data-target-selector="#">
