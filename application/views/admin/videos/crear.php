	...
	<div class="container">
		<div class="row">
			<form action="<?php echo base_url($action);?>" method="post" id="form" class="col s12 m10 l10">
				...
				<div class="input-field" >
					<input  type="text" id="imagen" class="modal-trigger" name="preview" placeholder="Imagen principal" data-expected="inactive" data-target="<?php echo $modalid; ?>"  value="<?php echo element('preview', $video, '');?>">
				</div>
				<br>
				<div class="input-field">
...
<div id="<?php echo $modalid; ?>" class="modal bottom-sheet" data-navigatefiles="active">
	<div class="modal-content">
		<h4>Seleccionar imagen</h4>
		<div class="row gallery" data-active-dir="./img"></div>
	</div>
</div>