...
<script type="text/javascript">
	...
	var fnMoveMessageTo = function(strIDFolder, fnCallback){
		if ($('.collection').attr('data-active-folder') != strIDFolder) {
			...
			if (strIdMessage) {
				$.ajax({
					url: str_base_url+'admin/mensajes/update_messagefolder_byajax/',
					type: 'POST',
					dataType: 'json',
	...
	var fnGetFolder = function (strIDFolder, fnCallback) {
		$.ajax({
			url: str_base_url+'admin/mensajes/getfolder/'+strIDFolder,
			type: 'POST',
			dataType: 'html'
		})
		.done(function(html) {
	...
	var fnSetMessageEvent = function() {
		$('.message').click(function(event) {
			...
			var element = this;
			$.ajax({
				url: str_base_url+'admin/mensajes/get_mensaje_by_ajax/',
				type: 'POST',
				dataType: 'html',
